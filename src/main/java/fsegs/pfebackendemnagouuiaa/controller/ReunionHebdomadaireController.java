...
public class ReunionHebdomadaireController {
    ...
    @PreAuthorize("hasAnyRole('ENCADRANT_ACADEMIQUE','ENCADRANT_PROFESSIONNEL','RESPONSABLE_SERVICE_STAGES','RESPONSABLE_UNIVERSITAIRE_STAGES','RESPONSABLE_ENTREPRISE','ADMINISTRATEUR')")
    @PostMapping
    ...
    @PreAuthorize("hasAnyRole('STAGIAIRE','ENCADRANT_ACADEMIQUE','ENCADRANT_PROFESSIONNEL','RESPONSABLE_SERVICE_STAGES','RESPONSABLE_UNIVERSITAIRE_STAGES','RESPONSABLE_ENTREPRISE','ADMINISTRATEUR')")
    @GetMapping("/{id}")
