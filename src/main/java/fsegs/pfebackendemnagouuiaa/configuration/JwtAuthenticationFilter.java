...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    // ✅ Sauter complètement le filtre pour les routes publiques
    @Override
    ...
    protected void doFilterInternal(
        ...
        try { // ✅ try-catch pour éviter un 403 silencieux si le token est malformé
            ...
            // Token invalide → on laisse Spring Security gérer (401 propre)
